...
namespace SecurityCodeScan.Analyzers
{
    ...
    public class RazorWriteLiteralXss: DiagnosticAnalyzer, IExternalFileAnalyzer
    {
        List<string>                                files    = new List<string>();
        public static readonly DiagnosticDescriptor razorWriteLiteralXSS = LocaleUtil.GetDescriptor("SCS0029_2");

        public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics { get; } = ImmutableArray.Create(razorWriteLiteralXSS);
        ...
        public void AnalyzeFile(AdditionalText file, CompilationAnalysisContext context)
        {
            ...
            {
                context.ReportDiagnostic(ExternalDiagnostic.Create(razorWriteLiteralXSS,
                                                                   file.Path,
